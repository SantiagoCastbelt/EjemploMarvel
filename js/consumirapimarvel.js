function consumirAPI() {
    ...
    var tablaMarvel = document.getElementById
        ("tablaMarvel")
    ...
    fetch(url)
        ...
        .then(json => {
            ...
            for (item of json.data.results) {
                ...
                var descripcionColumna = fila.insertCell(1);
                var nombreColumna = fila.insertCell(2);
                ...
                adiccionarHijo(imagenColumna,imagen);
               
                var urlImagen = item.thumbnail.path + "."
